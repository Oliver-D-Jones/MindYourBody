    ...
    <div class="container-fluid">
      <div class="row d-flex controls">
        <svg
          ...
          viewBox="0 0 16 16"
          class="col-3 bi bi-camera-video-off"
          fill="blue"
        ...
        <svg
          ...
          @click="toggleVideoPlay('myVideo')"
          viewBox="0 0 16 16"
          class="col-3 bi bi-camera-video"
          fill="blue"
          xmlns="http://www.w3.org/2000/svg"
          v-else
        >
